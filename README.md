...
>  声明三：请注意，本源码唯一交易渠道为QQ：877070886，没有其他QQ或微信，谨防被骗！！！  
>  声明四：请不要用本开源代码直接搭建交易所！本源码尚有一些隐藏BUG，仅供学习！否则后果自负！  
>  声明五：本交易所完整源码仅向有技术团队或技术实力的人提供，小白或不同技术的请勿咨询！

# 新功能持续开发中，敬请期待

- [x] 1.  锁仓释放（等额锁仓、等比锁仓、日/周/月/年周期释放）-已完成未开源  
- [x] 2.  闪兑（一键兑换USDT）-已完成未开源  
- [x] 3.  超级代理商（代理分销制度，代理自主管理发展用户）-已完成未开源  
- [x] 4.  超级机器人（可视化操作，掌握交易脉搏）-已完成未开源  
- [x] 5.  永续合约（撮合永续、对手永续、USDT本位永续）-进行中未开源  
- [x] 6.  差价合约（公正公平，用户无忧）-未开始未开源  
- [x] 7.  秒合约（极致收益、快进快出）-未开始未开源  
- [x] 8.  量化托管（省时省心，一键收益）-未开始未开源  
- [x] 9.  开放接口Api（大交易所必备）-未开始未开源  

- 注意：所有老客户购买新升级功能，可享5折优惠。
